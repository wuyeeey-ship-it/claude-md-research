...
5. **Never modify additional files during implementation** - If new files are required, return to PHASE 3 and update the plan
...
- `agent_docs/code_conventions.md` - Coding standards
- `agent_docs/testing_guide.md` - Testing approach
- `agent_docs/debugging.md` - Debugging procedures
